...
<body>
   ...
   <nav class="w3-topnav">
      ...
      <a href="http://172.16.81.56/showList.php#subbody"><i class="fa fa-arrow-left w3-xlarge"></i></a>
      <a href="http://172.16.81.56/PalWallet.html#mainbody"><i class="fa fa-home w3-xlarge"></i></a>
   ...
   <div class="w3-center w3-animate-zoom">
      <img class="w3-center" src="graph.php" />
   </div>
   <br/>
   <br/>
            ...
            if($row['name'] == $_SESSION["graphval"])
            {
               ...
               {	$lend = $lend + $row['amount']; 	               			
                  echo "<div class=\"w3-container w3-animate-left\">
                        <div class=\"w3-blockquote w3-green w3-xlarge w3-left w3-card-12\" style=\"width:750px;height:80px;\">
               ...
               {	$borrow = $borrow + $row['amount'];
                  echo "<div class=\"w3-container w3-animate-right\">
                        <div class=\"w3-blockquote w3-red w3-xlarge w3-right w3-card-12\" style=\"width:750px;height:80px;\">
